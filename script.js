...
document.addEventListener('DOMContentLoaded', function() {
  ...
  var translations = {
    en: {
      ...
      'about.heading': 'About',
      'about.p1': 'I’m a Frontend Developer with over two years of commercial experience building modern, scalable, and performance-focused web applications using React, Next.js, and TypeScript.',
      'about.p2': 'I specialize in creating reusable UI components, integrating REST APIs with TanStack Query, and delivering pixel-perfect interfaces based on Figma designs. I care deeply about clean architecture, performance optimization (Core Web Vitals), and writing maintainable code that scales in production environments.',
      ...
      'skills.react': 'REST API Integration + TanStack Query',
      'skills.a11y': 'Performance Optimization (Core Web Vitals)',
      'skills.perf': 'Component-Driven Architecture & Reusable UI',
    ...
    uk: {
      ...
      'about.p1': 'Я Frontend-розробник із понад двома роками комерційного досвіду створення сучасних, масштабованих та продуктивних веб-застосунків із використанням React, Next.js та TypeScript.',
      'about.p2': 'Спеціалізуюся на створенні перевикористовуваних UI-компонентів, інтеграції REST API за допомогою TanStack Query та точній реалізації інтерфейсів відповідно до Figma-дизайнів. Приділяю особливу увагу чистій архітектурі, оптимізації продуктивності (Core Web Vitals) та підтримуваності коду в production-середовищі.',
